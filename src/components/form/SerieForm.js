...
function SerieForm({handleSubmit, midiaData}){
    ...
    return(
        <form onSubmit={submit}>
            <Input type="text" text="Titulo" name="titulo" placeholder="Insira o Titulo da serie" handleOnChange={handleChange}/>

            <Input type="number" text="Temporada" name="temporada" placeholder="Insira a temporada da serie" handleOnChange={handleChange}/>

            <Input type="number" text="Episódio" name="episodio" placeholder="Insira o episódio da série" handleOnChange={handleChange}/>
